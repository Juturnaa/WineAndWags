...
const dogSeed = function (
  ...
  for (let i = 1; i < 1001; i++) {
    ...
    pool.query(
      `INSERT INTO waw.dogs(id, name, gender, bio, hypo, neutered, rating, owner_id, age, size, breed, healthy) VALUES (DEFAULT, '${name}', '${gen}', '${bi}', ${hyp}, ${neu}, ${rate}, ${owner}, ${ag}, '${si}', '${bre}', ${health})`,
    );
  }
};
