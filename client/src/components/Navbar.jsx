...
function NavBar({
  currentUser, likeProfile, humanPhoto, breeds, dogsImg, currentDogs, getRandomUser, matches, matchesPhotos, likePhoto, allMessages, currentUserID, potiential, potientialDog, matchesInfo,
}) {
  return (
    <BrowserRouter>
